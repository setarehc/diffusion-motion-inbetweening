...
class ForwardKinematicsLayer(nn.Module):
    ...
    def __init__(self, parents=None, positions=None, device=None):
        with open('data_loaders/amass/utils/smpl.yaml', 'r') as f:
        ...
        if parents is None and positions is None:
            ...
            smpl_fname = os.path.join(smpl['smpl_body_model'], 'male', 'model.npz')
